...
```bash
sf package install -p 04tgK000000HuAfQAK -o <your-org> -w 10
```

Or install from the browser:

- Production / Developer Edition: `https://login.salesforce.com/packaging/installPackage.apexp?p0=04tgK000000HuAfQAK`
- Sandbox: `https://test.salesforce.com/packaging/installPackage.apexp?p0=04tgK000000HuAfQAK`

Current version: **v1.5.0** (`04tgK000000HuAfQAK`). Install IDs for every release are listed on the [Releases](https://github.com/krile136/ApexTrace/releases) page.
